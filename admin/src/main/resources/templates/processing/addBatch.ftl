        ...
        <form id="form1" enctype="multipart/form-data" method="post">
            <table border="0" class="form-find" style="height: 45px;">
                ...
                <tr>
                    <td>内容合作经理:</td>
                    <td>
                        <input id="manager" name="manager" type="text" class="txt" style="width: 300px"/>&nbsp;&nbsp;&nbsp;<span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td>批次号:</td>
                    <td>
                        <input id="batchId" name="batchId" type="text" class="txt" style="width: 300px"/>&nbsp;&nbsp;&nbsp;<span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td>外协单位:</td>
