        ...
        <div id="basic" class="tabPanel">
            <table class="form">
                <tr>
                    ...
                    <td class="formValue">
                        <input id="id" name="id" value="${metaid!''}" type="text" class="txt required"
                ...
                <tr>
                    ...
                    <td class="formValue">
                        <input id="file" name="file" type="file" accept=".cebx" datacol="yes" checkexpession="NotNull"/>
                    </td>
                </tr>
            </table>
        </div>
...
<script>
    ...
    function AcceptClick() {
        ...
        window.setTimeout(function () {
            ...
            $.ajax({
                url: RootPath() + "/book/cebxChapterInsert",
                type: "POST",
                data: formData,
                cache: false,
                processData: false,
