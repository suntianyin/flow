            ...
            <#--<tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="manager" name="manager" value="${(batch.manager)!''}" type="text" class="txt"
                ...
                <tr>
                    <td>批次号:</td>
                    <td>
                        <input id="batchId" name="batchId" value="${(batch.batchId)!''}" type="text" class="txt"
                               style="width: 300px"/>&nbsp;&nbsp;&nbsp;<span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>文档格式:</td>
                    <td>
                        <input id="documentFormat" name="documentFormat" value="${(batch.documentFormat)!''}" type="text" class="txt" style="width: 300px"/>
                    </td>
                </tr>
                <tr>
                    <td>文档大概数量:</td>
                    <td>
                        <input id="documentNum" name="documentNum" value="${(batch.documentNum)!''}" type="text"
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="memo" name="memo" class="txt"
                                  style="width: 300px; height: 60px;">${(batch.memo)!''}</textarea>
                    </td>
                </tr>
            <#--<tr>
                <td>操作人:</td>
