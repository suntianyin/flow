        ...
        <div id="basic" class="tabPanel">
            <table class="form">
                ...
                <tr>
                    ...
                    <td class="formValue">
                        <input id="publishDate" name="publishDate" value="${bookMeta.issuedDate!''}" type="text"
                               class="txt required"
                               readonly datacol="yes" checkexpession="NotNull"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="formValue">
                        <input id="file" name="file" type="file" accept="image/*" datacol="yes"
...
<script>
    ...
    function AcceptClick() {
        ...
        window.setTimeout(function () {
            ...
            $.ajax({
                url: RootPath() + "/processing/bibliotheca/uploadImage2Server",
                type: "POST",
                data: formData,
                cache: false,
                processData: false,
