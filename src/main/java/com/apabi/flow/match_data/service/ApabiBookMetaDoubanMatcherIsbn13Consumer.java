...
public class ApabiBookMetaDoubanMatcherIsbn13Consumer implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            LOGGER.info(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + "  使用" + Thread.currentThread().getName() + "处理douban映射apabi第" + (pageNum - 1) * 10000 + "万到第" + pageNum  * 10000 + "万条数据，还剩余" + countDownLatch.getCount() + "条");
