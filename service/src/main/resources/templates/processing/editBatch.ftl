...
<#include "../common/metabootstraps.ftl">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#outUnit").val("${(batch.outUnit)!'' }");
            $("#sourceType").val("${(batch.sourceType.getCode())!'' }");
            $("#copyrightOwner").val("${(batch.copyrightOwner)!'' }");
        });
...
<div id="grid_List">
    <div class="bottomline QueryArea" style="margin: 1px; margin-top: 0px; margin-bottom: 0px;">
        <div class="btnbartitle">
            <div align="center"><span id="CenterTitle">修改批次</span></div>
        </div>
            ...
            <table border="0" class="form-find" style="height: 45px;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="manager" name="manager" value="${(batch.manager)!''}" type="text" class="txt" style="width: 300px"/>&nbsp;&nbsp;&nbsp;<span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td>批次号:</td>
                    <td>
                        <input id="batchId" name="batchId" value="${(batch.batchId)!''}" type="text" class="txt" style="width: 300px"/>&nbsp;&nbsp;&nbsp;<span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td>外协单位:</td>
                ...
                <tr>
                    <td>版权所有者:</td>
                    <td>
                        <select id="copyrightOwner" name="copyrightOwner" class="js-example-basic-single" underline="true"
                                style="width: 307px;">
                ...
                <tr>
                    <td>文档大概数量:</td>
                    <td>
                        <input id="documentNum" name="documentNum" value="${(batch.documentNum)!''}" type="text" class="txt" style="width: 300px"/>
                    </td>
                </tr>
                <tr>
                    <td>备注:</td>
                    <td>
                        <textarea id="memo" name="memo" class="txt" style="width: 300px; height: 60px;">${(batch.memo)!''}</textarea>
                    </td>
                </tr>
                <#--<tr>
                    <td>操作人:</td>
